                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature) => (
                            <Card key={feature.id} className="text-center">
                                ...
                                <h3 className="text-xl font-display font-bold text-metro-dark mb-3">
                                    {feature.title}
                                </h3>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-4xl md:text-5xl font-display font-bold text-metro-dark mb-6">
                        ...
                        >
                            <Card glass className="p-12 text-center">
                                ...
                                <h3 className="text-2xl font-bold text-metro-dark">Metro Route Map</h3>
                                <p className="text-gray-600 mt-2">Interactive station coverage</p>
                            </Card>
                        </motion.div>
                    </div>
                </div>
