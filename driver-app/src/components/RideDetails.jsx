            ...
            <div className="p-6 flex-1 overflow-y-auto space-y-8">
                <div className="space-y-6 relative">
                    ...
                    <div className="flex items-start space-x-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-white">{ride.pickupLocation?.address || 'Pickup Address'}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-white">{ride.dropLocation?.address || 'Drop-off Address'}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-dark-800 p-4 rounded-xl border border-dark-700">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-white font-bold text-lg">${ride.estimatedFare || '12.50'}</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-gray-400 text-sm">Distance</span>
                        <span className="text-white">{ride.estimatedDistance || '3.2 km'}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-400">Payment Method</span>
                        <span className="text-white">Card •••• 4242</span>
                    </div>
                </div>
            </div>
