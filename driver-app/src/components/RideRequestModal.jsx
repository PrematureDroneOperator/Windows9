                    ...
                    <div className="space-y-5 relative">
                        ...
                        <div className="flex items-start space-x-4 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-white font-semibold">{request.pickupLocation?.address || 'Unknown Pickup'}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-white font-semibold">{request.dropLocation?.address || 'Unknown Drop-off'}</p>
                            </div>
                        </div>
                    </div>
